...
class PrzesylkaNierejestrowanaZNumeremType extends PrzesylkaRejestrowanaType
{
    ...
    /**
     * @var null | \app\modules\postal\sender\Type\SerwisNierejestrowanaZNumeremType
     */
    private ?\app\modules\postal\sender\Type\SerwisNierejestrowanaZNumeremType $serwis = null;
    ...
    /**
     * @return null | \app\modules\postal\sender\Type\SerwisNierejestrowanaZNumeremType
     */
    public function getSerwis() : ?\app\modules\postal\sender\Type\SerwisNierejestrowanaZNumeremType
    {
        return $this->serwis;
    }

    /**
     * @param null | \app\modules\postal\sender\Type\SerwisNierejestrowanaZNumeremType $serwis
     * @return static
     */
    public function withSerwis(?\app\modules\postal\sender\Type\SerwisNierejestrowanaZNumeremType $serwis) : static
    {
        $new = clone $this;
        $new->serwis = $serwis;
