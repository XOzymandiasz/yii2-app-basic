...
class Clear extends AbstractSoapClientBase
{
     ...
     * @param \app\modules\postal\sender\StructType\ClearEnvelope $parameters
     * @return \app\modules\postal\sender\StructType\ClearEnvelopeResponse|bool
     ...
     * @param \app\modules\postal\sender\StructType\ClearEnvelopeByGuids $parameters
     * @return \app\modules\postal\sender\StructType\ClearEnvelopeByGuidsResponse|bool
     * @uses AbstractSoapClientBase::saveLastError()
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     */
    public function clearEnvelopeByGuids(\app\modules\postal\sender\StructType\ClearEnvelopeByGuids $parameters)
    {
        try {
    ...
    /**
     * Returns the result
     * @return \app\modules\postal\sender\StructType\ClearEnvelopeByGuidsResponse|\app\modules\postal\sender\StructType\ClearEnvelopeResponse
