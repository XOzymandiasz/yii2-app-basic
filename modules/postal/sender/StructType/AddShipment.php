...
class AddShipment extends AbstractStructBase
{
     ...
     * @param \app\modules\postal\sender\StructType\PrzesylkaType[] $przesylki
     * @param int $idBufor
     */
    ...
    public static function validatePrzesylkiForArrayConstraintFromSetPrzesylki(?array $values = []): string
    {
        ...
        foreach ($values as $addShipmentPrzesylkiItem) {
            ...
            if (!$addShipmentPrzesylkiItem instanceof \app\modules\postal\sender\StructType\PrzesylkaType) {
     ...
     * @return \app\modules\postal\sender\StructType\AddShipment
     */
    public function addToPrzesylki(\app\modules\postal\sender\StructType\PrzesylkaType $item): self
    {
        // validation for constraint: itemType
