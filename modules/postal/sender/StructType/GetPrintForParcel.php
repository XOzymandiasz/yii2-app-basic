...
class GetPrintForParcel extends AbstractStructBase
{
     ...
     * @var \app\modules\postal\sender\StructType\PrintType|null
     */
    protected ?\app\modules\postal\sender\StructType\PrintType $type = null;
    /**
     * Constructor method for getPrintForParcel
     * @uses GetPrintForParcel::setGuid()
     * @uses GetPrintForParcel::setType()
     * @param string[] $guid
     * @param \app\modules\postal\sender\StructType\PrintType $type
     */
    public function __construct(?array $guid = null, ?\app\modules\postal\sender\StructType\PrintType $type = null)
    {
        $this
            ->setGuid($guid)
            ->setType($type);
    ...
    /**
     * Get type value
     * @return \app\modules\postal\sender\StructType\PrintType|null
     */
    public function getType(): ?\app\modules\postal\sender\StructType\PrintType
    {
        return $this->type;
    }
    /**
     ...
     * @return \app\modules\postal\sender\StructType\GetPrintForParcel
     */
    public function setType(?\app\modules\postal\sender\StructType\PrintType $type = null): self
    {
        $this->type = $type;
