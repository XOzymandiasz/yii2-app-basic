...
class PobranieType extends AbstractStructBase
{
     ...
     * @uses \app\modules\postal\sender\EnumType\SposobPobraniaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\SposobPobraniaType::getValidValues()
