...
class DoreczeniePrzesylkiType extends AbstractStructBase
{
     ...
     * @uses \app\modules\postal\sender\EnumType\PodmiotDoreczeniaEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\PodmiotDoreczeniaEnum::getValidValues()
     ...
     * @uses \app\modules\postal\sender\EnumType\MiejscePozostawieniaZawiadomieniaODoreczeniuEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\MiejscePozostawieniaZawiadomieniaODoreczeniuEnum::getValidValues()
     * @throws InvalidArgumentException
     * @param string $miejscePozostawieniaZawiadomieniaODoreczeniu
     * @return \app\modules\postal\sender\StructType\DoreczeniePrzesylkiType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\MiejscePozostawieniaZawiadomieniaODoreczeniuEnum::valueIsValid($miejscePozostawieniaZawiadomieniaODoreczeniu)) {
