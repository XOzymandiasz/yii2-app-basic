...
class ProduktyInKartaType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\ProduktInKartaType[]
     */
    protected ?array $produktInKarta = null;
    /**
     * Constructor method for produktyInKartaType
     * @uses ProduktyInKartaType::setProduktInKarta()
     * @param \app\modules\postal\sender\StructType\ProduktInKartaType[] $produktInKarta
     */
    ...
    public static function validateProduktInKartaForArrayConstraintFromSetProduktInKarta(?array $values = []): string
    {
        ...
        foreach ($values as $produktyInKartaTypeProduktInKartaItem) {
            ...
            if (!$produktyInKartaTypeProduktInKartaItem instanceof \app\modules\postal\sender\StructType\ProduktInKartaType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\ProduktInKartaType $item
     * @return \app\modules\postal\sender\StructType\ProduktyInKartaType
     */
    public function addToProduktInKarta(\app\modules\postal\sender\StructType\ProduktInKartaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\ProduktInKartaType) {
