...
class DokumentyTowarzyszaceType extends AbstractStructBase
{
    ...
    /**
     * Set rodzaj value
     * @uses \app\modules\postal\sender\EnumType\DokumentTowarzyszacyRodzajEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\DokumentTowarzyszacyRodzajEnum::getValidValues()
    ...
    public function setRodzaj(?string $rodzaj = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\DokumentTowarzyszacyRodzajEnum::valueIsValid($rodzaj)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\DokumentTowarzyszacyRodzajEnum', is_array($rodzaj) ? implode(', ', $rodzaj) : var_export($rodzaj, true), implode(', ', \app\modules\postal\sender\EnumType\DokumentTowarzyszacyRodzajEnum::getValidValues())), __LINE__);
        }
        $this->rodzaj = $rodzaj;
