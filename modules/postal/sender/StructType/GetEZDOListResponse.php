...
class GetEZDOListResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\EZDOPakietType[]
     */
    protected ?array $EZDOPakiet = null;
    /**
     * Constructor method for getEZDOListResponse
     * @uses GetEZDOListResponse::setEZDOPakiet()
     * @param \app\modules\postal\sender\StructType\EZDOPakietType[] $eZDOPakiet
     */
    ...
    public static function validateEZDOPakietForArrayConstraintFromSetEZDOPakiet(?array $values = []): string
    {
        ...
        foreach ($values as $getEZDOListResponseEZDOPakietItem) {
            ...
            if (!$getEZDOListResponseEZDOPakietItem instanceof \app\modules\postal\sender\StructType\EZDOPakietType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\EZDOPakietType $item
     * @return \app\modules\postal\sender\StructType\GetEZDOListResponse
     */
    public function addToEZDOPakiet(\app\modules\postal\sender\StructType\EZDOPakietType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\EZDOPakietType) {
