...
class SetStatusZgodyNaEZwrot extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \app\modules\postal\sender\StructType\StatusZgodyEZwrotType[]
     */
    protected ?array $statusZgody = null;
    /**
     * Constructor method for setStatusZgodyNaEZwrot
     * @uses SetStatusZgodyNaEZwrot::setStatusZgody()
     * @param \app\modules\postal\sender\StructType\StatusZgodyEZwrotType[] $statusZgody
     */
    ...
    public static function validateStatusZgodyForArrayConstraintFromSetStatusZgody(?array $values = []): string
    {
        ...
        foreach ($values as $setStatusZgodyNaEZwrotStatusZgodyItem) {
            ...
            if (!$setStatusZgodyNaEZwrotStatusZgodyItem instanceof \app\modules\postal\sender\StructType\StatusZgodyEZwrotType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\StatusZgodyEZwrotType $item
     * @return \app\modules\postal\sender\StructType\SetStatusZgodyNaEZwrot
     */
    public function addToStatusZgody(\app\modules\postal\sender\StructType\StatusZgodyEZwrotType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\StatusZgodyEZwrotType) {
