...
class ReklamacjaRozpatrzonaType extends AbstractStructBase
{
     ...
     * @uses \app\modules\postal\sender\EnumType\RozstrzygniecieType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\RozstrzygniecieType::getValidValues()
