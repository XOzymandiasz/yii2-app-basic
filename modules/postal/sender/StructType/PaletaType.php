...
class PaletaType extends AbstractStructBase
{
     ...
     * @uses \app\modules\postal\sender\EnumType\RodzajPaletyType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\RodzajPaletyType::getValidValues()
    ...
    public function setRodzajPalety(?string $rodzajPalety = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\RodzajPaletyType::valueIsValid($rodzajPalety)) {
