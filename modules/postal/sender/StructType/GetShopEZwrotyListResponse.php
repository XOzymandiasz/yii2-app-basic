...
class GetShopEZwrotyListResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\ShopEZwrotyInfoType[]
     */
    protected ?array $shops = null;
    /**
     * Constructor method for getShopEZwrotyListResponse
     * @uses GetShopEZwrotyListResponse::setShops()
     * @param \app\modules\postal\sender\StructType\ShopEZwrotyInfoType[] $shops
     */
    ...
    public static function validateShopsForArrayConstraintFromSetShops(?array $values = []): string
    {
        ...
        foreach ($values as $getShopEZwrotyListResponseShopsItem) {
            ...
            if (!$getShopEZwrotyListResponseShopsItem instanceof \app\modules\postal\sender\StructType\ShopEZwrotyInfoType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\ShopEZwrotyInfoType $item
     * @return \app\modules\postal\sender\StructType\GetShopEZwrotyListResponse
     */
    public function addToShops(\app\modules\postal\sender\StructType\ShopEZwrotyInfoType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\ShopEZwrotyInfoType) {
