...
class GetUrzedyNadaniaResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\UrzadNadaniaFullType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\UrzadNadaniaFullType[] $urzedyNadania
     */
    ...
    public static function validateUrzedyNadaniaForArrayConstraintFromSetUrzedyNadania(?array $values = []): string
    {
        ...
        foreach ($values as $getUrzedyNadaniaResponseUrzedyNadaniaItem) {
            ...
            if (!$getUrzedyNadaniaResponseUrzedyNadaniaItem instanceof \app\modules\postal\sender\StructType\UrzadNadaniaFullType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\UrzadNadaniaFullType $item
     * @return \app\modules\postal\sender\StructType\GetUrzedyNadaniaResponse
     */
    public function addToUrzedyNadania(\app\modules\postal\sender\StructType\UrzadNadaniaFullType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\UrzadNadaniaFullType) {
