...
class StatusZgodyEZwrotType extends AbstractStructBase
{
    ...
    public static function validateEZwrotPrzesylkiForArrayConstraintFromSetEZwrotPrzesylki(?array $values = []): string
    {
        ...
        foreach ($values as $statusZgodyEZwrotTypeEZwrotPrzesylkiItem) {
            ...
            if (!\app\modules\postal\sender\EnumType\EZwrotPrzesylkiType::valueIsValid($statusZgodyEZwrotTypeEZwrotPrzesylkiItem)) {
    ...
    /**
     * Set status value
     * @uses \app\modules\postal\sender\EnumType\StatusZgodyEZwrotNameType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\StatusZgodyEZwrotNameType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $status
     * @return \app\modules\postal\sender\StructType\StatusZgodyEZwrotType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\StatusZgodyEZwrotNameType::valueIsValid($status)) {
