...
class ChecklistTemplateType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\AdditionalActivityType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\AdditionalActivityType[] $additionalActivity
     * @param string $guid
     */
    ...
    public function setService(?string $service = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\SerwisPrzesylkaProceduralnaType::valueIsValid($service)) {
    ...
    public static function validateAdditionalActivityForArrayConstraintFromSetAdditionalActivity(?array $values = []): string
    {
        ...
        foreach ($values as $checklistTemplateTypeAdditionalActivityItem) {
            ...
            if (!$checklistTemplateTypeAdditionalActivityItem instanceof \app\modules\postal\sender\StructType\AdditionalActivityType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\AdditionalActivityType $item
     * @return \app\modules\postal\sender\StructType\ChecklistTemplateType
     */
    public function addToAdditionalActivity(\app\modules\postal\sender\StructType\AdditionalActivityType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\AdditionalActivityType) {
