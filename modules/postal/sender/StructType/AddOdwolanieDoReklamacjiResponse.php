...
class AddOdwolanieDoReklamacjiResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: 500
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\ReklamacjaInfoType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\ReklamacjaInfoType[] $reklamacjaInfo
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $addOdwolanieDoReklamacjiResponseErrorItem) {
            ...
            if (!$addOdwolanieDoReklamacjiResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
    ...
    public static function validateReklamacjaInfoForArrayConstraintFromSetReklamacjaInfo(?array $values = []): string
    {
        ...
        foreach ($values as $addOdwolanieDoReklamacjiResponseReklamacjaInfoItem) {
            // validation for constraint: itemType
            if (!$addOdwolanieDoReklamacjiResponseReklamacjaInfoItem instanceof \app\modules\postal\sender\StructType\ReklamacjaInfoType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\ReklamacjaInfoType $item
     * @return \app\modules\postal\sender\StructType\AddOdwolanieDoReklamacjiResponse
     */
    public function addToReklamacjaInfo(\app\modules\postal\sender\StructType\ReklamacjaInfoType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\ReklamacjaInfoType) {
