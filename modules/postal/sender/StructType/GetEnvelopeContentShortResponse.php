...
class GetEnvelopeContentShortResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\PrzesylkaShortType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\PrzesylkaShortType[] $przesylka
     */
    ...
    public static function validatePrzesylkaForArrayConstraintFromSetPrzesylka(?array $values = []): string
    {
        ...
        foreach ($values as $getEnvelopeContentShortResponsePrzesylkaItem) {
            ...
            if (!$getEnvelopeContentShortResponsePrzesylkaItem instanceof \app\modules\postal\sender\StructType\PrzesylkaShortType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\PrzesylkaShortType $item
     * @return \app\modules\postal\sender\StructType\GetEnvelopeContentShortResponse
     */
    public function addToPrzesylka(\app\modules\postal\sender\StructType\PrzesylkaShortType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\PrzesylkaShortType) {
