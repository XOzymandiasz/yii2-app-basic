...
class AddShipmentResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: 500
     * @var \app\modules\postal\sender\StructType\AddShipmentResponseItemType[]
     */
    protected ?array $retval = null;
    /**
     * Constructor method for addShipmentResponse
     * @uses AddShipmentResponse::setRetval()
     * @param \app\modules\postal\sender\StructType\AddShipmentResponseItemType[] $retval
     */
    ...
    public static function validateRetvalForArrayConstraintFromSetRetval(?array $values = []): string
    {
        ...
        foreach ($values as $addShipmentResponseRetvalItem) {
            ...
            if (!$addShipmentResponseRetvalItem instanceof \app\modules\postal\sender\StructType\AddShipmentResponseItemType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\AddShipmentResponseItemType $item
     * @return \app\modules\postal\sender\StructType\AddShipmentResponse
     */
    public function addToRetval(\app\modules\postal\sender\StructType\AddShipmentResponseItemType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\AddShipmentResponseItemType) {
