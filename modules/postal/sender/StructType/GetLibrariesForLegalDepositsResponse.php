...
class GetLibrariesForLegalDepositsResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\LibraryForLegalDepositType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\LibraryForLegalDepositType[] $libraryForLegalDeposit
     */
    ...
    public static function validateLibraryForLegalDepositForArrayConstraintFromSetLibraryForLegalDeposit(?array $values = []): string
    {
        ...
        foreach ($values as $getLibrariesForLegalDepositsResponseLibraryForLegalDepositItem) {
            ...
            if (!$getLibrariesForLegalDepositsResponseLibraryForLegalDepositItem instanceof \app\modules\postal\sender\StructType\LibraryForLegalDepositType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\LibraryForLegalDepositType $item
     * @return \app\modules\postal\sender\StructType\GetLibrariesForLegalDepositsResponse
     */
    public function addToLibraryForLegalDeposit(\app\modules\postal\sender\StructType\LibraryForLegalDepositType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\LibraryForLegalDepositType) {
