...
class ShopEZwrotyType extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\EZwrotKartaType|null
     */
    protected ?\app\modules\postal\sender\StructType\EZwrotKartaType $eZwrotKarta = null;
    /**
     * The idShop
     * @var int|null
     */
     ...
     * @param \app\modules\postal\sender\StructType\EZwrotKartaType $eZwrotKarta
     * @param int $idShop
     * @param string $nazwa2
    ...
    public static function validateEZwrotPrzesylkiForArrayConstraintFromSetEZwrotPrzesylki(?array $values = []): string
    {
        ...
        foreach ($values as $shopEZwrotyTypeEZwrotPrzesylkiItem) {
            ...
            if (!\app\modules\postal\sender\EnumType\EZwrotPrzesylkiType::valueIsValid($shopEZwrotyTypeEZwrotPrzesylkiItem)) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\EZwrotPrzesylkiType', is_array($invalidValues) ? implode(', ', $invalidValues) : var_export($invalidValues, true), implode(', ', \app\modules\postal\sender\EnumType\EZwrotPrzesylkiType::getValidValues()));
        }
        unset($invalidValues);
     ...
     * @uses \app\modules\postal\sender\EnumType\EZwrotPrzesylkiType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\EZwrotPrzesylkiType::getValidValues()
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\EZwrotPrzesylkiType::valueIsValid($item)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\EZwrotPrzesylkiType', is_array($item) ? implode(', ', $item) : var_export($item, true), implode(', ', \app\modules\postal\sender\EnumType\EZwrotPrzesylkiType::getValidValues())), __LINE__);
        }
        // validation for constraint: maxOccurs(2)
     ...
     * @return \app\modules\postal\sender\StructType\EZwrotKartaType|null
     */
    public function getEZwrotKarta(): ?\app\modules\postal\sender\StructType\EZwrotKartaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\ShopEZwrotyType
     */
    public function setEZwrotKarta(?\app\modules\postal\sender\StructType\EZwrotKartaType $eZwrotKarta = null): self
    {
    ...
    /**
     * Set eZwrotTyp value
     * @uses \app\modules\postal\sender\EnumType\EZwrotTypZgodyType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\EZwrotTypZgodyType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $eZwrotTyp
     * @return \app\modules\postal\sender\StructType\ShopEZwrotyType
     */
     ...
     * @uses \app\modules\postal\sender\EnumType\WymagalnoscNumeruIdentyfikujacegoPrzesylkeEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\WymagalnoscNumeruIdentyfikujacegoPrzesylkeEnum::getValidValues()
     * @throws InvalidArgumentException
     * @param string $wymagalnoscNumeruIdentyfikujacegoPrzesylke
     * @return \app\modules\postal\sender\StructType\ShopEZwrotyType
     */
