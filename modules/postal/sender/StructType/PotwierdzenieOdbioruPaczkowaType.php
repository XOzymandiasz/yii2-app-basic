...
class PotwierdzenieOdbioruPaczkowaType extends AbstractStructBase
{
    ...
    /**
     * Set sposob value
     * @uses \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::getValidValues()
    ...
    public function setSposob(?string $sposob = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::valueIsValid($sposob)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType', is_array($sposob) ? implode(', ', $sposob) : var_export($sposob, true), implode(', ', \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruPocztowaType::getValidValues())), __LINE__);
        }
        $this->sposob = $sposob;
