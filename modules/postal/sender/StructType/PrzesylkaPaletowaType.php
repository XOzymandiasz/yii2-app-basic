...
class PrzesylkaPaletowaType extends PrzesylkaRejestrowanaType
{
     ...
     * @var \app\modules\postal\sender\StructType\AdresType|null
     */
    protected ?\app\modules\postal\sender\StructType\AdresType $miejsceDoreczenia = null;
    /**
     * The paleta
     * @var \app\modules\postal\sender\StructType\PaletaType|null
     */
    protected ?\app\modules\postal\sender\StructType\PaletaType $paleta = null;
    /**
     * The platnik
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\PlatnikType|null
     */
    protected ?\app\modules\postal\sender\StructType\PlatnikType $platnik = null;
    /**
     * The pobranie
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * - maxOccurs: 32
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\SubPrzesylkaPaletowaType[]
     */
     ...
     * - maxOccurs: 10
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\DaneSentType[]
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\AwizacjaType|null
     */
    protected ?\app\modules\postal\sender\StructType\AwizacjaType $awizacja = null;
    /**
     * The zawartosc
     * @var string|null
     */
     ...
     * @param \app\modules\postal\sender\StructType\AdresType $miejsceDoreczenia
     * @param \app\modules\postal\sender\StructType\PaletaType $paleta
     * @param \app\modules\postal\sender\StructType\PlatnikType $platnik
     * @param \app\modules\postal\sender\StructType\PobranieType $pobranie
     * @param \app\modules\postal\sender\StructType\SubPrzesylkaPaletowaType[] $subPaleta
     * @param \app\modules\postal\sender\StructType\DaneSentType[] $daneSent
     * @param \app\modules\postal\sender\StructType\AwizacjaType $awizacja
     ...
     * @param bool $awizoSMS
     */
    public function __construct(?\app\modules\postal\sender\StructType\AdresType $miejsceOdbioru = null, ?\app\modules\postal\sender\StructType\AdresType $miejsceDoreczenia = null, ?\app\modules\postal\sender\StructType\PaletaType $paleta = null, ?\app\modules\postal\sender\StructType\PlatnikType $platnik = null, ?\app\modules\postal\sender\StructType\PobranieType $pobranie = null, ?array $subPaleta = null, ?array $daneSent = null, ?\app\modules\postal\sender\StructType\AwizacjaType $awizacja = null, ?string $zawartosc = null, ?int $masa = null, ?string $dataZaladunku = null, ?string $dataDostawy = null, ?int $wartosc = null, ?int $iloscZwracanychPaletEUR = null, ?string $zalaczonaFV = null, ?string $zalaczonyWZ = null, ?string $zalaczoneInne = null, ?string $zwracanaFV = null, ?string $zwracanyWZ = null, ?string $zwracaneInne = null, ?string $powiadomienieNadawcy = null, ?string $powiadomienieOdbiorcy = null, ?bool $dostawaWSobote = null, ?bool $przygotowanieDokumentowPrzewozowych = null, ?bool $dostawaSamochodemDedykowanym = null, ?bool $zmianaDanychAdresowych = null, ?bool $ustalenieTerminuDostawy = null, ?bool $samochodZWinda = null, ?bool $zabranieOpakowania = null, ?bool $wniesienie = null, ?bool $awizoSMS = null)
    {
        $this
     ...
     * @return \app\modules\postal\sender\StructType\AdresType|null
     */
    public function getMiejsceDoreczenia(): ?\app\modules\postal\sender\StructType\AdresType
    {
     ...
     * @return \app\modules\postal\sender\StructType\PrzesylkaPaletowaType
     */
    public function setMiejsceDoreczenia(?\app\modules\postal\sender\StructType\AdresType $miejsceDoreczenia = null): self
    {
    ...
    /**
     * Get paleta value
     * @return \app\modules\postal\sender\StructType\PaletaType|null
     */
    public function getPaleta(): ?\app\modules\postal\sender\StructType\PaletaType
    {
        return $this->paleta;
    }
    /**
     ...
     * @return \app\modules\postal\sender\StructType\PrzesylkaPaletowaType
     */
    public function setPaleta(?\app\modules\postal\sender\StructType\PaletaType $paleta = null): self
    {
        $this->paleta = $paleta;
    ...
    /**
     * Get platnik value
     * @return \app\modules\postal\sender\StructType\PlatnikType|null
     */
    public function getPlatnik(): ?\app\modules\postal\sender\StructType\PlatnikType
    {
        return $this->platnik;
    }
    /**
     ...
     * @return \app\modules\postal\sender\StructType\PrzesylkaPaletowaType
     */
    public function setPlatnik(?\app\modules\postal\sender\StructType\PlatnikType $platnik = null): self
    {
    ...
    public static function validateSubPaletaForArrayConstraintFromSetSubPaleta(?array $values = []): string
    {
        ...
        foreach ($values as $przesylkaPaletowaTypeSubPaletaItem) {
            ...
            if (!$przesylkaPaletowaTypeSubPaletaItem instanceof \app\modules\postal\sender\StructType\SubPrzesylkaPaletowaType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\SubPrzesylkaPaletowaType $item
     * @return \app\modules\postal\sender\StructType\PrzesylkaPaletowaType
     */
    public function addToSubPaleta(\app\modules\postal\sender\StructType\SubPrzesylkaPaletowaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\SubPrzesylkaPaletowaType) {
    ...
    public static function validateDaneSentForArrayConstraintFromSetDaneSent(?array $values = []): string
    {
        ...
        foreach ($values as $przesylkaPaletowaTypeDaneSentItem) {
            // validation for constraint: itemType
            if (!$przesylkaPaletowaTypeDaneSentItem instanceof \app\modules\postal\sender\StructType\DaneSentType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\DaneSentType $item
     * @return \app\modules\postal\sender\StructType\PrzesylkaPaletowaType
     */
    public function addToDaneSent(\app\modules\postal\sender\StructType\DaneSentType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\DaneSentType) {
    ...
    /**
     * Get awizacja value
     * @return \app\modules\postal\sender\StructType\AwizacjaType|null
     */
    public function getAwizacja(): ?\app\modules\postal\sender\StructType\AwizacjaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\PrzesylkaPaletowaType
     */
    public function setAwizacja(?\app\modules\postal\sender\StructType\AwizacjaType $awizacja = null): self
    {
    ...
    public function setPowiadomienieOdbiorcy(?string $powiadomienieOdbiorcy = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\ESposobPowiadomieniaType::valueIsValid($powiadomienieOdbiorcy)) {
