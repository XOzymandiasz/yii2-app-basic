...
class GetReturnDocumentsProfileListResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\ReturnDocumentProfileType[]
     */
    ...
    public static function validateProfileForArrayConstraintFromSetProfile(?array $values = []): string
    {
        ...
        foreach ($values as $getReturnDocumentsProfileListResponseProfileItem) {
            ...
            if (!$getReturnDocumentsProfileListResponseProfileItem instanceof \app\modules\postal\sender\StructType\ReturnDocumentProfileType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\ReturnDocumentProfileType $item
     * @return \app\modules\postal\sender\StructType\GetReturnDocumentsProfileListResponse
     */
    public function addToProfile(\app\modules\postal\sender\StructType\ReturnDocumentProfileType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\ReturnDocumentProfileType) {
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getReturnDocumentsProfileListResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getReturnDocumentsProfileListResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
