...
class PrzesylkaPoleconaZagranicznaType extends PrzesylkaRejestrowanaType
{
     ...
     */
    public function __construct(?\app\modules\postal\sender\StructType\DeklaracjaCelna2Type $deklaracjaCelna2 = null, ?string $zawartosc = null, ?bool $posteRestante = false, ?int $masa = null, ?int $iloscPotwierdzenOdbioru = null, ?string $numerPrzesylkiKlienta = null)
    {
        $this
