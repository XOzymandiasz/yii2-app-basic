...
class AddZalacznikDoReklamacji extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * @var \app\modules\postal\sender\StructType\ZalacznikDoReklamacjiType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\ZalacznikDoReklamacjiType[] $zalacznik
     */
    ...
    public static function validateZalacznikForArrayConstraintFromSetZalacznik(?array $values = []): string
    {
        ...
        foreach ($values as $addZalacznikDoReklamacjiZalacznikItem) {
            ...
            if (!$addZalacznikDoReklamacjiZalacznikItem instanceof \app\modules\postal\sender\StructType\ZalacznikDoReklamacjiType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\ZalacznikDoReklamacjiType $item
     * @return \app\modules\postal\sender\StructType\AddZalacznikDoReklamacji
     */
    public function addToZalacznik(\app\modules\postal\sender\StructType\ZalacznikDoReklamacjiType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\ZalacznikDoReklamacjiType) {
