...
class DeklaracjaCelnaType extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * @var \app\modules\postal\sender\StructType\SzczegolyDeklaracjiCelnejType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\SzczegolyDeklaracjiCelnejType[] $szczegoly
    ...
    public static function validateSzczegolyForArrayConstraintFromSetSzczegoly(?array $values = []): string
    {
        ...
        foreach ($values as $deklaracjaCelnaTypeSzczegolyItem) {
            ...
            if (!$deklaracjaCelnaTypeSzczegolyItem instanceof \app\modules\postal\sender\StructType\SzczegolyDeklaracjiCelnejType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\SzczegolyDeklaracjiCelnejType $item
     * @return \app\modules\postal\sender\StructType\DeklaracjaCelnaType
     */
    public function addToSzczegoly(\app\modules\postal\sender\StructType\SzczegolyDeklaracjiCelnejType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\SzczegolyDeklaracjiCelnejType) {
