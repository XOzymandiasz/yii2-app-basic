...
class RelatedToAllegroType extends AbstractStructBase
{
    ...
    /**
     * Set channel value
     * @uses \app\modules\postal\sender\EnumType\RelatedToAllegroChannelType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\RelatedToAllegroChannelType::getValidValues()
    ...
    public function setChannel(?string $channel = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\RelatedToAllegroChannelType::valueIsValid($channel)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\RelatedToAllegroChannelType', is_array($channel) ? implode(', ', $channel) : var_export($channel, true), implode(', ', \app\modules\postal\sender\EnumType\RelatedToAllegroChannelType::getValidValues())), __LINE__);
        }
