...
class AddReklamacje extends AbstractStructBase
{
     ...
     * - maxOccurs: 500
     * @var \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType[]
     */
    protected ?array $reklamowanaPrzesylka = null;
    /**
     * Constructor method for addReklamacje
     * @uses AddReklamacje::setReklamowanaPrzesylka()
     * @param \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType[] $reklamowanaPrzesylka
     */
    ...
    public static function validateReklamowanaPrzesylkaForArrayConstraintFromSetReklamowanaPrzesylka(?array $values = []): string
    {
        ...
        foreach ($values as $addReklamacjeReklamowanaPrzesylkaItem) {
            ...
            if (!$addReklamacjeReklamowanaPrzesylkaItem instanceof \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType $item
     * @return \app\modules\postal\sender\StructType\AddReklamacje
     */
    public function addToReklamowanaPrzesylka(\app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType) {
