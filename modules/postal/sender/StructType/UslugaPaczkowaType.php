...
class UslugaPaczkowaType extends PrzesylkaRejestrowanaType
{
     ...
     * - choiceMinOccurs: 1
     * - maxOccurs: unbounded
     * @var \app\modules\postal\sender\StructType\SubUslugaPaczkowaType[]
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\PotwierdzenieOdbioruPaczkowaType|null
     */
    protected ?\app\modules\postal\sender\StructType\PotwierdzenieOdbioruPaczkowaType $potwierdzenieOdbioru = null;
    /**
     * The ubezpieczenie
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\DoreczenieUslugaPocztowaType|null
     */
    protected ?\app\modules\postal\sender\StructType\DoreczenieUslugaPocztowaType $doreczenie = null;
    /**
     * The epo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \app\modules\postal\sender\StructType\SubUslugaPaczkowaType[] $subPrzesylka
     * @param \app\modules\postal\sender\StructType\PotwierdzenieOdbioruPaczkowaType $potwierdzenieOdbioru
     ...
     * @param \app\modules\postal\sender\StructType\DoreczenieUslugaPocztowaType $doreczenie
     ...
     * @return \app\modules\postal\sender\StructType\SubUslugaPaczkowaType[]|null
     */
    ...
    public static function validateSubPrzesylkaForArrayConstraintFromSetSubPrzesylka(?array $values = []): string
    {
        ...
        foreach ($values as $uslugaPaczkowaTypeSubPrzesylkaItem) {
            ...
            if (!$uslugaPaczkowaTypeSubPrzesylkaItem instanceof \app\modules\postal\sender\StructType\SubUslugaPaczkowaType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\SubUslugaPaczkowaType $item
     * @return \app\modules\postal\sender\StructType\UslugaPaczkowaType
     */
    public function addToSubPrzesylka(\app\modules\postal\sender\StructType\SubUslugaPaczkowaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\SubUslugaPaczkowaType) {
     ...
     * @return \app\modules\postal\sender\StructType\PotwierdzenieOdbioruPaczkowaType|null
     */
    public function getPotwierdzenieOdbioru(): ?\app\modules\postal\sender\StructType\PotwierdzenieOdbioruPaczkowaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\UslugaPaczkowaType
     */
    public function setPotwierdzenieOdbioru(?\app\modules\postal\sender\StructType\PotwierdzenieOdbioruPaczkowaType $potwierdzenieOdbioru = null): self
    {
     ...
     * @uses \app\modules\postal\sender\EnumType\ZwrotDokumentowPaczkowaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\ZwrotDokumentowPaczkowaType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $zwrotDokumentow
     * @return \app\modules\postal\sender\StructType\UslugaPaczkowaType
     */
     ...
     * @return \app\modules\postal\sender\StructType\DoreczenieUslugaPocztowaType|null
     */
    public function getDoreczenie(): ?\app\modules\postal\sender\StructType\DoreczenieUslugaPocztowaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\UslugaPaczkowaType
     */
    public function setDoreczenie(?\app\modules\postal\sender\StructType\DoreczenieUslugaPocztowaType $doreczenie = null): self
    {
    ...
    /**
     * Set termin value
     * @uses \app\modules\postal\sender\EnumType\TerminPaczkowaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\TerminPaczkowaType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $termin
     * @return \app\modules\postal\sender\StructType\UslugaPaczkowaType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\TerminPaczkowaType::valueIsValid($termin)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\TerminPaczkowaType', is_array($termin) ? implode(', ', $termin) : var_export($termin, true), implode(', ', \app\modules\postal\sender\EnumType\TerminPaczkowaType::getValidValues())), __LINE__);
        }
        $this->termin = $termin;
     ...
     * @uses \app\modules\postal\sender\EnumType\OpakowaniePocztowaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\OpakowaniePocztowaType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $opakowanie
     * @return \app\modules\postal\sender\StructType\UslugaPaczkowaType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\OpakowaniePocztowaType::valueIsValid($opakowanie)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\OpakowaniePocztowaType', is_array($opakowanie) ? implode(', ', $opakowanie) : var_export($opakowanie, true), implode(', ', \app\modules\postal\sender\EnumType\OpakowaniePocztowaType::getValidValues())), __LINE__);
        }
