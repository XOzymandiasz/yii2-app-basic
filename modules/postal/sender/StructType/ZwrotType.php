...
class ZwrotType extends AbstractStructBase
{
     ...
     * @uses \app\modules\postal\sender\EnumType\SposobZwrotuType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\SposobZwrotuType::getValidValues()
