...
class GetReklamacjeResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\ReklamacjaRozpatrzonaType[]
     */
    protected ?array $reklamacja = null;
    /**
     * Constructor method for getReklamacjeResponse
     * @uses GetReklamacjeResponse::setReklamacja()
     * @param \app\modules\postal\sender\StructType\ReklamacjaRozpatrzonaType[] $reklamacja
     */
    ...
    public static function validateReklamacjaForArrayConstraintFromSetReklamacja(?array $values = []): string
    {
        ...
        foreach ($values as $getReklamacjeResponseReklamacjaItem) {
            ...
            if (!$getReklamacjeResponseReklamacjaItem instanceof \app\modules\postal\sender\StructType\ReklamacjaRozpatrzonaType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\ReklamacjaRozpatrzonaType $item
     * @return \app\modules\postal\sender\StructType\GetReklamacjeResponse
     */
    public function addToReklamacja(\app\modules\postal\sender\StructType\ReklamacjaRozpatrzonaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\ReklamacjaRozpatrzonaType) {
