...
class GetPrintForParcelResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\PrintResultType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\PrintResultType[] $printResult
    ...
    public static function validatePrintResultForArrayConstraintFromSetPrintResult(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintForParcelResponsePrintResultItem) {
            ...
            if (!$getPrintForParcelResponsePrintResultItem instanceof \app\modules\postal\sender\StructType\PrintResultType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\PrintResultType $item
     * @return \app\modules\postal\sender\StructType\GetPrintForParcelResponse
     */
    public function addToPrintResult(\app\modules\postal\sender\StructType\PrintResultType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\PrintResultType) {
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getPrintForParcelResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getPrintForParcelResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
