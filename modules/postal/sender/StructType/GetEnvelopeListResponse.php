...
class GetEnvelopeListResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\EnvelopeInfoType[]
     */
    protected ?array $envelopes = null;
    /**
     * Constructor method for getEnvelopeListResponse
     * @uses GetEnvelopeListResponse::setEnvelopes()
     * @param \app\modules\postal\sender\StructType\EnvelopeInfoType[] $envelopes
     */
    ...
    public static function validateEnvelopesForArrayConstraintFromSetEnvelopes(?array $values = []): string
    {
        ...
        foreach ($values as $getEnvelopeListResponseEnvelopesItem) {
            ...
            if (!$getEnvelopeListResponseEnvelopesItem instanceof \app\modules\postal\sender\StructType\EnvelopeInfoType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\EnvelopeInfoType $item
     * @return \app\modules\postal\sender\StructType\GetEnvelopeListResponse
     */
    public function addToEnvelopes(\app\modules\postal\sender\StructType\EnvelopeInfoType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\EnvelopeInfoType) {
