...
class PowodReklamacjiType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \app\modules\postal\sender\StructType\PowodSzczegolowyType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\PowodSzczegolowyType[] $powodSzczegolowy
    ...
    public static function validatePowodSzczegolowyForArrayConstraintFromSetPowodSzczegolowy(?array $values = []): string
    {
        ...
        foreach ($values as $powodReklamacjiTypePowodSzczegolowyItem) {
            ...
            if (!$powodReklamacjiTypePowodSzczegolowyItem instanceof \app\modules\postal\sender\StructType\PowodSzczegolowyType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\PowodSzczegolowyType $item
     * @return \app\modules\postal\sender\StructType\PowodReklamacjiType
     */
    public function addToPowodSzczegolowy(\app\modules\postal\sender\StructType\PowodSzczegolowyType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\PowodSzczegolowyType) {
