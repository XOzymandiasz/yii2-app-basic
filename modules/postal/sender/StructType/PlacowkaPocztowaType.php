...
class PlacowkaPocztowaType extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\LokalizacjaGeograficznaType|null
     */
    protected ?\app\modules\postal\sender\StructType\LokalizacjaGeograficznaType $lokalizacjaGeograficzna = null;
    /**
     * The godzinyPracy
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\GodzinyPracyType|null
     */
    protected ?\app\modules\postal\sender\StructType\GodzinyPracyType $godzinyPracy = null;
    /**
     * The opis
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\DeliveryPathType|null
     */
    protected ?\app\modules\postal\sender\StructType\DeliveryPathType $deliveryPath = null;
    /**
     * The typ
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param int $id
     * @param \app\modules\postal\sender\StructType\LokalizacjaGeograficznaType $lokalizacjaGeograficzna
     * @param \app\modules\postal\sender\StructType\GodzinyPracyType $godzinyPracy
     * @param string $opis
     * @param \app\modules\postal\sender\StructType\DeliveryPathType $deliveryPath
     * @param string $typ
     ...
     * @param string $idZPO
     */
    public function __construct(int $id, ?\app\modules\postal\sender\StructType\LokalizacjaGeograficznaType $lokalizacjaGeograficzna = null, ?\app\modules\postal\sender\StructType\GodzinyPracyType $godzinyPracy = null, ?string $opis = null, ?\app\modules\postal\sender\StructType\DeliveryPathType $deliveryPath = null, ?string $typ = null, ?array $rodzajPlatnosci = null, ?string $funkcja = null, ?int $maksymalnaKwotaPobrania = null, ?string $prefixNazwy = null, ?string $nazwa = null, ?string $wojewodztwo = null, ?string $powiat = null, ?string $miejsce = null, ?string $kodPocztowy = null, ?string $miejscowosc = null, ?string $ulica = null, ?string $numerDomu = null, ?string $numerLokalu = null, ?string $nazwaWydruk = null, ?bool $punktWydaniaEPrzesylki = null, ?bool $powiadomienieSMS = null, ?bool $punktWydaniaPrzesylkiBiznesowejPlus = null, ?bool $punktWydaniaPrzesylkiBiznesowej = null, ?string $siecPlacowek = null, ?string $idZPO = null)
    {
        $this
            ->setId($id)
     ...
     * @return \app\modules\postal\sender\StructType\LokalizacjaGeograficznaType|null
     */
    public function getLokalizacjaGeograficzna(): ?\app\modules\postal\sender\StructType\LokalizacjaGeograficznaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\PlacowkaPocztowaType
     */
    public function setLokalizacjaGeograficzna(?\app\modules\postal\sender\StructType\LokalizacjaGeograficznaType $lokalizacjaGeograficzna = null): self
    {
     ...
     * @return \app\modules\postal\sender\StructType\GodzinyPracyType|null
     */
    public function getGodzinyPracy(): ?\app\modules\postal\sender\StructType\GodzinyPracyType
    {
     ...
     * @return \app\modules\postal\sender\StructType\PlacowkaPocztowaType
     */
    public function setGodzinyPracy(?\app\modules\postal\sender\StructType\GodzinyPracyType $godzinyPracy = null): self
    {
     ...
     * @return \app\modules\postal\sender\StructType\DeliveryPathType|null
     */
    public function getDeliveryPath(): ?\app\modules\postal\sender\StructType\DeliveryPathType
    {
     ...
     * @return \app\modules\postal\sender\StructType\PlacowkaPocztowaType
     */
    public function setDeliveryPath(?\app\modules\postal\sender\StructType\DeliveryPathType $deliveryPath = null): self
    {
    ...
    /**
     * Set typ value
     * @uses \app\modules\postal\sender\EnumType\TypPlacowkiPocztowejEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\TypPlacowkiPocztowejEnum::getValidValues()
    ...
    public function setTyp(?string $typ = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\TypPlacowkiPocztowejEnum::valueIsValid($typ)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\TypPlacowkiPocztowejEnum', is_array($typ) ? implode(', ', $typ) : var_export($typ, true), implode(', ', \app\modules\postal\sender\EnumType\TypPlacowkiPocztowejEnum::getValidValues())), __LINE__);
        }
        $this->typ = $typ;
    ...
    public static function validateRodzajPlatnosciForArrayConstraintFromSetRodzajPlatnosci(?array $values = []): string
    {
        ...
        foreach ($values as $placowkaPocztowaTypeRodzajPlatnosciItem) {
            // validation for constraint: enumeration
            if (!\app\modules\postal\sender\EnumType\RodzajPlatnosciEnum::valueIsValid($placowkaPocztowaTypeRodzajPlatnosciItem)) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\RodzajPlatnosciEnum', is_array($invalidValues) ? implode(', ', $invalidValues) : var_export($invalidValues, true), implode(', ', \app\modules\postal\sender\EnumType\RodzajPlatnosciEnum::getValidValues()));
        }
        unset($invalidValues);
     ...
     * @uses \app\modules\postal\sender\EnumType\RodzajPlatnosciEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\RodzajPlatnosciEnum::getValidValues()
     * @throws InvalidArgumentException
     * @param string[] $rodzajPlatnosci
     * @return \app\modules\postal\sender\StructType\PlacowkaPocztowaType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\RodzajPlatnosciEnum::valueIsValid($item)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\RodzajPlatnosciEnum', is_array($item) ? implode(', ', $item) : var_export($item, true), implode(', ', \app\modules\postal\sender\EnumType\RodzajPlatnosciEnum::getValidValues())), __LINE__);
        }
    ...
    /**
     * Set funkcja value
     * @uses \app\modules\postal\sender\EnumType\FunkcjaPlacowkiPocztowejType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\FunkcjaPlacowkiPocztowejType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $funkcja
     * @return \app\modules\postal\sender\StructType\PlacowkaPocztowaType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\FunkcjaPlacowkiPocztowejType::valueIsValid($funkcja)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\FunkcjaPlacowkiPocztowejType', is_array($funkcja) ? implode(', ', $funkcja) : var_export($funkcja, true), implode(', ', \app\modules\postal\sender\EnumType\FunkcjaPlacowkiPocztowejType::getValidValues())), __LINE__);
        }
