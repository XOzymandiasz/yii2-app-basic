...
class ZwrotPrzesylkiType extends AbstractStructBase
{
    ...
    /**
     * Set przyczyna value
     * @uses \app\modules\postal\sender\EnumType\PrzyczynaZwrotuEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\PrzyczynaZwrotuEnum::getValidValues()
    ...
    public function setPrzyczyna(?string $przyczyna = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\PrzyczynaZwrotuEnum::valueIsValid($przyczyna)) {
