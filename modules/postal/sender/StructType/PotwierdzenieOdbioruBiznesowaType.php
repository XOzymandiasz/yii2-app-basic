...
class PotwierdzenieOdbioruBiznesowaType extends AbstractStructBase
{
    ...
    /**
     * Set sposob value
     * @uses \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaBiznesowaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaBiznesowaType::getValidValues()
    ...
    public function setSposob(?string $sposob = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaBiznesowaType::valueIsValid($sposob)) {
