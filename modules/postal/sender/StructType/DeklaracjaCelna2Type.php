...
class DeklaracjaCelna2Type extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\DokumentyTowarzyszaceType[]
     */
     ...
     * Meta information extracted from the WSDL
     * - maxOccurs: 5
     * @var \app\modules\postal\sender\StructType\SzczegolyZawartosciPrzesylkiZagranicznejType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\DokumentyTowarzyszaceType[] $dokumentyTowarzyszace
     ...
     * @param \app\modules\postal\sender\StructType\SzczegolyZawartosciPrzesylkiZagranicznejType[] $szczegolyZawartosciPrzesylki
    ...
    /**
     * Set rodzaj value
     * @uses \app\modules\postal\sender\EnumType\DeklaracaCelnaRodzajEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\DeklaracaCelnaRodzajEnum::getValidValues()
    ...
    public function setRodzaj(?string $rodzaj = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\DeklaracaCelnaRodzajEnum::valueIsValid($rodzaj)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\DeklaracaCelnaRodzajEnum', is_array($rodzaj) ? implode(', ', $rodzaj) : var_export($rodzaj, true), implode(', ', \app\modules\postal\sender\EnumType\DeklaracaCelnaRodzajEnum::getValidValues())), __LINE__);
        }
        $this->rodzaj = $rodzaj;
     ...
     * @uses \app\modules\postal\sender\EnumType\ZawartoscPrzesylkiZagranicznejEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\ZawartoscPrzesylkiZagranicznejEnum::getValidValues()
     * @throws InvalidArgumentException
     * @param string $zawartoscPrzesylki
     * @return \app\modules\postal\sender\StructType\DeklaracjaCelna2Type
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\ZawartoscPrzesylkiZagranicznejEnum::valueIsValid($zawartoscPrzesylki)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\ZawartoscPrzesylkiZagranicznejEnum', is_array($zawartoscPrzesylki) ? implode(', ', $zawartoscPrzesylki) : var_export($zawartoscPrzesylki, true), implode(', ', \app\modules\postal\sender\EnumType\ZawartoscPrzesylkiZagranicznejEnum::getValidValues())), __LINE__);
        }
     ...
     * @return \app\modules\postal\sender\StructType\DokumentyTowarzyszaceType[]
     */
    ...
    public static function validateDokumentyTowarzyszaceForArrayConstraintFromSetDokumentyTowarzyszace(?array $values = []): string
    {
        ...
        foreach ($values as $deklaracjaCelna2TypeDokumentyTowarzyszaceItem) {
            ...
            if (!$deklaracjaCelna2TypeDokumentyTowarzyszaceItem instanceof \app\modules\postal\sender\StructType\DokumentyTowarzyszaceType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\DokumentyTowarzyszaceType $item
     * @return \app\modules\postal\sender\StructType\DeklaracjaCelna2Type
     */
    public function addToDokumentyTowarzyszace(\app\modules\postal\sender\StructType\DokumentyTowarzyszaceType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\DokumentyTowarzyszaceType) {
    ...
    public static function validateSzczegolyZawartosciPrzesylkiForArrayConstraintFromSetSzczegolyZawartosciPrzesylki(?array $values = []): string
    {
        ...
        foreach ($values as $deklaracjaCelna2TypeSzczegolyZawartosciPrzesylkiItem) {
            // validation for constraint: itemType
            if (!$deklaracjaCelna2TypeSzczegolyZawartosciPrzesylkiItem instanceof \app\modules\postal\sender\StructType\SzczegolyZawartosciPrzesylkiZagranicznejType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\SzczegolyZawartosciPrzesylkiZagranicznejType $item
     * @return \app\modules\postal\sender\StructType\DeklaracjaCelna2Type
     */
    public function addToSzczegolyZawartosciPrzesylki(\app\modules\postal\sender\StructType\SzczegolyZawartosciPrzesylkiZagranicznejType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\SzczegolyZawartosciPrzesylkiZagranicznejType) {
