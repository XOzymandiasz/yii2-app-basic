...
class PrzesylkaNierejestrowanaZNumeremType extends PrzesylkaRejestrowanaType
{
    ...
    /**
     * Set serwis value
     * @uses \app\modules\postal\sender\EnumType\SerwisNierejestrowanaZNumeremType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\SerwisNierejestrowanaZNumeremType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $serwis
     * @return \app\modules\postal\sender\StructType\PrzesylkaNierejestrowanaZNumeremType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\SerwisNierejestrowanaZNumeremType::valueIsValid($serwis)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\SerwisNierejestrowanaZNumeremType', is_array($serwis) ? implode(', ', $serwis) : var_export($serwis, true), implode(', ', \app\modules\postal\sender\EnumType\SerwisNierejestrowanaZNumeremType::getValidValues())), __LINE__);
        }
        $this->serwis = $serwis;
