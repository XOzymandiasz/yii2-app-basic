...
class KategoriePowodowReklamacjiType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \app\modules\postal\sender\StructType\PowodReklamacjiType[]
     */
    ...
    public static function validatePowodReklamacjiForArrayConstraintFromSetPowodReklamacji(?array $values = []): string
    {
        ...
        foreach ($values as $kategoriePowodowReklamacjiTypePowodReklamacjiItem) {
            ...
            if (!$kategoriePowodowReklamacjiTypePowodReklamacjiItem instanceof \app\modules\postal\sender\StructType\PowodReklamacjiType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\PowodReklamacjiType $item
     * @return \app\modules\postal\sender\StructType\KategoriePowodowReklamacjiType
     */
    public function addToPowodReklamacji(\app\modules\postal\sender\StructType\PowodReklamacjiType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\PowodReklamacjiType) {
