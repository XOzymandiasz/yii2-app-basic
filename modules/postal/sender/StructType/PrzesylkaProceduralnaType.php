...
class PrzesylkaProceduralnaType extends PrzesylkaRejestrowanaType
{
    ...
    /**
     * Set serwis value
     * @uses \app\modules\postal\sender\EnumType\SerwisPrzesylkaProceduralnaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\SerwisPrzesylkaProceduralnaType::getValidValues()
    ...
    public function setSerwis(?string $serwis = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\SerwisPrzesylkaProceduralnaType::valueIsValid($serwis)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\SerwisPrzesylkaProceduralnaType', is_array($serwis) ? implode(', ', $serwis) : var_export($serwis, true), implode(', ', \app\modules\postal\sender\EnumType\SerwisPrzesylkaProceduralnaType::getValidValues())), __LINE__);
        }
        $this->serwis = $serwis;
     ...
     * @uses \app\modules\postal\sender\EnumType\OpakowaniePrzesylkaProceduralnaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\OpakowaniePrzesylkaProceduralnaType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $opakowanie
     * @return \app\modules\postal\sender\StructType\PrzesylkaProceduralnaType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\OpakowaniePrzesylkaProceduralnaType::valueIsValid($opakowanie)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\OpakowaniePrzesylkaProceduralnaType', is_array($opakowanie) ? implode(', ', $opakowanie) : var_export($opakowanie, true), implode(', ', \app\modules\postal\sender\EnumType\OpakowaniePrzesylkaProceduralnaType::getValidValues())), __LINE__);
        }
