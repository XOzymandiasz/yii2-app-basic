...
class GetKierunkiInfoResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \app\modules\postal\sender\StructType\UslugiType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\UslugiType[] $usluga
    ...
    public static function validateUslugaForArrayConstraintFromSetUsluga(?array $values = []): string
    {
        ...
        foreach ($values as $getKierunkiInfoResponseUslugaItem) {
            ...
            if (!$getKierunkiInfoResponseUslugaItem instanceof \app\modules\postal\sender\StructType\UslugiType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\UslugiType $item
     * @return \app\modules\postal\sender\StructType\GetKierunkiInfoResponse
     */
    public function addToUsluga(\app\modules\postal\sender\StructType\UslugiType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\UslugiType) {
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getKierunkiInfoResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getKierunkiInfoResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
