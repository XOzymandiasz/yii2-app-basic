...
class GetJednostkaOrganizacyjnaResponse extends AbstractStructBase
{
    ...
    public static function validateJednostkaOrganizacyjnaForArrayConstraintFromSetJednostkaOrganizacyjna(?array $values = []): string
    {
        ...
        foreach ($values as $getJednostkaOrganizacyjnaResponseJednostkaOrganizacyjnaItem) {
            ...
            if (!$getJednostkaOrganizacyjnaResponseJednostkaOrganizacyjnaItem instanceof \app\modules\postal\sender\StructType\JednostkaOrganizacyjnaType) {
     ...
     * @param \app\modules\postal\sender\StructType\JednostkaOrganizacyjnaType[] $jednostkaOrganizacyjna
     * @return \app\modules\postal\sender\StructType\GetJednostkaOrganizacyjnaResponse
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getJednostkaOrganizacyjnaResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getJednostkaOrganizacyjnaResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
