...
class GetListaZgodEZwrotowResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\OczekujeNaZgodeEZwrotType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\OczekujeNaZgodeEZwrotType[] $lista
    ...
    public static function validateListaForArrayConstraintFromSetLista(?array $values = []): string
    {
        ...
        foreach ($values as $getListaZgodEZwrotowResponseListaItem) {
            ...
            if (!$getListaZgodEZwrotowResponseListaItem instanceof \app\modules\postal\sender\StructType\OczekujeNaZgodeEZwrotType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\OczekujeNaZgodeEZwrotType $item
     * @return \app\modules\postal\sender\StructType\GetListaZgodEZwrotowResponse
     */
    public function addToLista(\app\modules\postal\sender\StructType\OczekujeNaZgodeEZwrotType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\OczekujeNaZgodeEZwrotType) {
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getListaZgodEZwrotowResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getListaZgodEZwrotowResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
