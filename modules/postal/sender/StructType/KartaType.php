...
class KartaType extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\ProduktyInKartaType|null
     */
    protected ?\app\modules\postal\sender\StructType\ProduktyInKartaType $produktyInKarta = null;
    /**
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\AdresKorespondencyjny[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\ProduktyInKartaType $produktyInKarta
     * @param \app\modules\postal\sender\StructType\AdresKorespondencyjny[] $adresKorespondencyjny
     * @param int $idKarta
     * @param string $opis
     * @param bool $aktywna
     * @param int $typ
     */
    public function __construct(?\app\modules\postal\sender\StructType\ProduktyInKartaType $produktyInKarta = null, ?array $adresKorespondencyjny = null, ?int $idKarta = null, ?string $opis = null, ?bool $aktywna = null, ?int $typ = null)
    {
        $this
     ...
     * @return \app\modules\postal\sender\StructType\ProduktyInKartaType|null
     */
    public function getProduktyInKarta(): ?\app\modules\postal\sender\StructType\ProduktyInKartaType
    {
     ...
     */
    public function setProduktyInKarta(?\app\modules\postal\sender\StructType\ProduktyInKartaType $produktyInKarta = null): self
    {
    ...
    public static function validateAdresKorespondencyjnyForArrayConstraintFromSetAdresKorespondencyjny(?array $values = []): string
    {
        ...
        foreach ($values as $kartaTypeAdresKorespondencyjnyItem) {
            ...
            if (!$kartaTypeAdresKorespondencyjnyItem instanceof \app\modules\postal\sender\StructType\AdresKorespondencyjny) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\AdresKorespondencyjny $item
     * @return \app\modules\postal\sender\StructType\KartaType
     */
    public function addToAdresKorespondencyjny(\app\modules\postal\sender\StructType\AdresKorespondencyjny $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\AdresKorespondencyjny) {
