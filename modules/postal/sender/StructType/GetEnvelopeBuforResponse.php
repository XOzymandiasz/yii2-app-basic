...
class GetEnvelopeBuforResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\PrzesylkaType[]
     */
    ...
    public static function validatePrzesylkaForArrayConstraintFromSetPrzesylka(?array $values = []): string
    {
        ...
        foreach ($values as $getEnvelopeBuforResponsePrzesylkaItem) {
            ...
            if (!$getEnvelopeBuforResponsePrzesylkaItem instanceof \app\modules\postal\sender\StructType\PrzesylkaType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\PrzesylkaType $item
     * @return \app\modules\postal\sender\StructType\GetEnvelopeBuforResponse
     */
    public function addToPrzesylka(\app\modules\postal\sender\StructType\PrzesylkaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\PrzesylkaType) {
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getEnvelopeBuforResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getEnvelopeBuforResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
