...
class Pocztex2021NaDzisType extends Pocztex2021Type
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\SubPocztex2021NaDzisType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\SubPocztex2021NaDzisType[] $subPrzesylka
     * @param int $odleglosc
     * @param string $obszar
     */
     ...
     * @return \app\modules\postal\sender\StructType\SubPocztex2021NaDzisType[]
     */
    ...
    public static function validateSubPrzesylkaForArrayConstraintFromSetSubPrzesylka(?array $values = []): string
    {
        ...
        foreach ($values as $pocztex2021NaDzisTypeSubPrzesylkaItem) {
            ...
            if (!$pocztex2021NaDzisTypeSubPrzesylkaItem instanceof \app\modules\postal\sender\StructType\SubPocztex2021NaDzisType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\SubPocztex2021NaDzisType $item
     * @return \app\modules\postal\sender\StructType\Pocztex2021NaDzisType
     */
    public function addToSubPrzesylka(\app\modules\postal\sender\StructType\SubPocztex2021NaDzisType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\SubPocztex2021NaDzisType) {
    ...
    /**
     * Set obszar value
     * @uses \app\modules\postal\sender\EnumType\ObszarType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\ObszarType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $obszar
     * @return \app\modules\postal\sender\StructType\Pocztex2021NaDzisType
     */
    public function setObszar(?string $obszar = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\ObszarType::valueIsValid($obszar)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\ObszarType', is_array($obszar) ? implode(', ', $obszar) : var_export($obszar, true), implode(', ', \app\modules\postal\sender\EnumType\ObszarType::getValidValues())), __LINE__);
        }
        $this->obszar = $obszar;
