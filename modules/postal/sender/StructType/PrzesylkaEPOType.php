...
class PrzesylkaEPOType extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\EPOInfoType|null
     */
    protected ?\app\modules\postal\sender\StructType\EPOInfoType $EPOInfo = null;
    /**
     ...
     * @param \app\modules\postal\sender\StructType\EPOInfoType $ePOInfo
     ...
     */
    public function __construct(?\app\modules\postal\sender\StructType\EPOInfoType $ePOInfo = null, ?string $biometricSignatureContent = null, ?int $version = null, ?string $guid = null, ?string $numerNadania = null, ?string $statusEPO = null)
    {
        $this
            ->setEPOInfo($ePOInfo)
    ...
    /**
     * Get EPOInfo value
     * @return \app\modules\postal\sender\StructType\EPOInfoType|null
     */
    public function getEPOInfo(): ?\app\modules\postal\sender\StructType\EPOInfoType
    {
        return $this->EPOInfo;
    }
    /**
     ...
     */
    public function setEPOInfo(?\app\modules\postal\sender\StructType\EPOInfoType $ePOInfo = null): self
    {
    ...
    /**
     * Set statusEPO value
     * @uses \app\modules\postal\sender\EnumType\StatusEPOEnum::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\StatusEPOEnum::getValidValues()
    ...
    public function setStatusEPO(?string $statusEPO = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\StatusEPOEnum::valueIsValid($statusEPO)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\StatusEPOEnum', is_array($statusEPO) ? implode(', ', $statusEPO) : var_export($statusEPO, true), implode(', ', \app\modules\postal\sender\EnumType\StatusEPOEnum::getValidValues())), __LINE__);
        }
