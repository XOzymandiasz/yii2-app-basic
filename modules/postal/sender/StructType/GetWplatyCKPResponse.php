...
class GetWplatyCKPResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\WplataCKPType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\WplataCKPType[] $wplaty
    ...
    public static function validateWplatyForArrayConstraintFromSetWplaty(?array $values = []): string
    {
        ...
        foreach ($values as $getWplatyCKPResponseWplatyItem) {
            ...
            if (!$getWplatyCKPResponseWplatyItem instanceof \app\modules\postal\sender\StructType\WplataCKPType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\WplataCKPType $item
     * @return \app\modules\postal\sender\StructType\GetWplatyCKPResponse
     */
    public function addToWplaty(\app\modules\postal\sender\StructType\WplataCKPType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\WplataCKPType) {
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getWplatyCKPResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getWplatyCKPResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
