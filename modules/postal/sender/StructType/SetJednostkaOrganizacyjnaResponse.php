...
class SetJednostkaOrganizacyjnaResponse extends AbstractStructBase
{
     ...
     * @param \app\modules\postal\sender\StructType\JednostkaOrganizacyjnaType[] $jednostkaOrganizacyjna
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $setJednostkaOrganizacyjnaResponseErrorItem) {
            ...
            if (!$setJednostkaOrganizacyjnaResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
     ...
     * @param \app\modules\postal\sender\StructType\ErrorType[] $error
     * @return \app\modules\postal\sender\StructType\SetJednostkaOrganizacyjnaResponse
     */
    ...
    public static function validateJednostkaOrganizacyjnaForArrayConstraintFromSetJednostkaOrganizacyjna(?array $values = []): string
    {
        ...
        foreach ($values as $setJednostkaOrganizacyjnaResponseJednostkaOrganizacyjnaItem) {
            // validation for constraint: itemType
            if (!$setJednostkaOrganizacyjnaResponseJednostkaOrganizacyjnaItem instanceof \app\modules\postal\sender\StructType\JednostkaOrganizacyjnaType) {
     ...
     * @return \app\modules\postal\sender\StructType\SetJednostkaOrganizacyjnaResponse
     */
    public function addToJednostkaOrganizacyjna(\app\modules\postal\sender\StructType\JednostkaOrganizacyjnaType $item): self
    {
        // validation for constraint: itemType
