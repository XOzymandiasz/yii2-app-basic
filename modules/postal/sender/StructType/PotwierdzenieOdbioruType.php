...
class PotwierdzenieOdbioruType extends AbstractStructBase
{
    ...
    /**
     * Set sposob value
     * @uses \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruType::getValidValues()
    ...
    public function setSposob(?string $sposob = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruType::valueIsValid($sposob)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruType', is_array($sposob) ? implode(', ', $sposob) : var_export($sposob, true), implode(', ', \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruType::getValidValues())), __LINE__);
        }
        $this->sposob = $sposob;
