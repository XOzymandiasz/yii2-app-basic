...
class PotwierdzenieOdbioruKurierskaType extends AbstractStructBase
{
    ...
    /**
     * Set sposob value
     * @uses \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruKurierskaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruKurierskaType::getValidValues()
    ...
    public function setSposob(?string $sposob = null): self
    {
        ...
        if (!\app\modules\postal\sender\EnumType\SposobPrzekazaniaPotwierdzeniaOdbioruKurierskaType::valueIsValid($sposob)) {
