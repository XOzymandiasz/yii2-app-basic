...
class ZwrotDokumentowType extends AbstractStructBase
{
     ...
     * @param int $odleglosc
     */
    public function __construct(?string $rodzajPocztex = null, ?\app\modules\postal\sender\StructType\RodzajListType $rodzajList = null, ?int $odleglosc = null)
    {
        $this
     ...
     * @uses \app\modules\postal\sender\EnumType\TerminRodzajType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\TerminRodzajType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $rodzajPocztex
