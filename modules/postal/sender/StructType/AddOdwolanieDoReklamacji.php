...
class AddOdwolanieDoReklamacji extends AbstractStructBase
{
     ...
     * @param \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType[] $reklamacja
     */
    ...
    public static function validateReklamacjaForArrayConstraintFromSetReklamacja(?array $values = []): string
    {
        ...
        foreach ($values as $addOdwolanieDoReklamacjiReklamacjaItem) {
            ...
            if (!$addOdwolanieDoReklamacjiReklamacjaItem instanceof \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType) {
     ...
     * @return \app\modules\postal\sender\StructType\AddOdwolanieDoReklamacji
     */
    public function addToReklamacja(\app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType $item): self
    {
        // validation for constraint: itemType
