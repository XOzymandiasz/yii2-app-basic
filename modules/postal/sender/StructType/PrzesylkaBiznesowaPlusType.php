...
class PrzesylkaBiznesowaPlusType extends PrzesylkaRejestrowanaType
{
     ...
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\PlacowkaPocztowaType|null
     */
    protected ?\app\modules\postal\sender\StructType\PlacowkaPocztowaType $urzadWydaniaPrzesylki = null;
    /**
     * The subPrzesylka
     * Meta information extracted from the WSDL
     * - maxOccurs: 100
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\SubPrzesylkaBiznesowaPlusType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\PlacowkaPocztowaType $urzadWydaniaPrzesylki
     * @param \app\modules\postal\sender\StructType\SubPrzesylkaBiznesowaPlusType[] $subPrzesylka
     ...
     * @return \app\modules\postal\sender\StructType\PlacowkaPocztowaType|null
     */
    public function getUrzadWydaniaPrzesylki(): ?\app\modules\postal\sender\StructType\PlacowkaPocztowaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\PrzesylkaBiznesowaPlusType
     */
    public function setUrzadWydaniaPrzesylki(?\app\modules\postal\sender\StructType\PlacowkaPocztowaType $urzadWydaniaPrzesylki = null): self
    {
    ...
    public static function validateSubPrzesylkaForArrayConstraintFromSetSubPrzesylka(?array $values = []): string
    {
        ...
        foreach ($values as $przesylkaBiznesowaPlusTypeSubPrzesylkaItem) {
            ...
            if (!$przesylkaBiznesowaPlusTypeSubPrzesylkaItem instanceof \app\modules\postal\sender\StructType\SubPrzesylkaBiznesowaPlusType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\SubPrzesylkaBiznesowaPlusType $item
     * @return \app\modules\postal\sender\StructType\PrzesylkaBiznesowaPlusType
     */
    public function addToSubPrzesylka(\app\modules\postal\sender\StructType\SubPrzesylkaBiznesowaPlusType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\SubPrzesylkaBiznesowaPlusType) {
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\ESposobPowiadomieniaType::valueIsValid($eSposobPowiadomieniaAdresata)) {
     ...
     * @uses \app\modules\postal\sender\EnumType\TerminRodzajPlusType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\TerminRodzajPlusType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $terminRodzajPlus
     * @return \app\modules\postal\sender\StructType\PrzesylkaBiznesowaPlusType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\TerminRodzajPlusType::valueIsValid($terminRodzajPlus)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\TerminRodzajPlusType', is_array($terminRodzajPlus) ? implode(', ', $terminRodzajPlus) : var_export($terminRodzajPlus, true), implode(', ', \app\modules\postal\sender\EnumType\TerminRodzajPlusType::getValidValues())), __LINE__);
        }
