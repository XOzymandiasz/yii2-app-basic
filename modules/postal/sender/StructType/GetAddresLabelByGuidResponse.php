...
class GetAddresLabelByGuidResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\AddressLabelContent[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\AddressLabelContent[] $content
    ...
    public static function validateContentForArrayConstraintFromSetContent(?array $values = []): string
    {
        ...
        foreach ($values as $getAddresLabelByGuidResponseContentItem) {
            ...
            if (!$getAddresLabelByGuidResponseContentItem instanceof \app\modules\postal\sender\StructType\AddressLabelContent) {
     ...
     * @param \app\modules\postal\sender\StructType\AddressLabelContent[] $content
     * @return \app\modules\postal\sender\StructType\GetAddresLabelByGuidResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\AddressLabelContent $item
     * @return \app\modules\postal\sender\StructType\GetAddresLabelByGuidResponse
     */
    public function addToContent(\app\modules\postal\sender\StructType\AddressLabelContent $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\AddressLabelContent) {
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getAddresLabelByGuidResponseErrorItem) {
            // validation for constraint: itemType
            if (!$getAddresLabelByGuidResponseErrorItem instanceof \app\modules\postal\sender\StructType\ErrorType) {
