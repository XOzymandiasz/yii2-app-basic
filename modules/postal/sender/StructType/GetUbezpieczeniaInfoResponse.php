...
class GetUbezpieczeniaInfoResponse extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\UbezpieczeniaInfoType[]
     */
     ...
     * @param \app\modules\postal\sender\StructType\UbezpieczeniaInfoType[] $poziomyUbezpieczenia
     */
    ...
    public static function validatePoziomyUbezpieczeniaForArrayConstraintFromSetPoziomyUbezpieczenia(?array $values = []): string
    {
        ...
        foreach ($values as $getUbezpieczeniaInfoResponsePoziomyUbezpieczeniaItem) {
            ...
            if (!$getUbezpieczeniaInfoResponsePoziomyUbezpieczeniaItem instanceof \app\modules\postal\sender\StructType\UbezpieczeniaInfoType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\UbezpieczeniaInfoType $item
     * @return \app\modules\postal\sender\StructType\GetUbezpieczeniaInfoResponse
     */
    public function addToPoziomyUbezpieczenia(\app\modules\postal\sender\StructType\UbezpieczeniaInfoType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\UbezpieczeniaInfoType) {
