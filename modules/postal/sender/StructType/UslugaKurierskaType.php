...
class UslugaKurierskaType extends PrzesylkaRejestrowanaType
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\OdbiorPrzesylkiOdNadawcyType|null
     */
    protected ?\app\modules\postal\sender\StructType\OdbiorPrzesylkiOdNadawcyType $odbiorPrzesylkiOdNadawcy = null;
    /**
     ...
     * - choiceMinOccurs: 1
     * - maxOccurs: unbounded
     * @var \app\modules\postal\sender\StructType\SubUslugaKurierskaType[]
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\PotwierdzenieOdbioruKurierskaType|null
     */
    protected ?\app\modules\postal\sender\StructType\PotwierdzenieOdbioruKurierskaType $potwierdzenieOdbioru = null;
    /**
     * The ubezpieczenie
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\ZwrotDokumentowKurierskaType|null
     */
    protected ?\app\modules\postal\sender\StructType\ZwrotDokumentowKurierskaType $zwrotDokumentow = null;
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \app\modules\postal\sender\StructType\DoreczenieUslugaKurierskaType|null
     */
    protected ?\app\modules\postal\sender\StructType\DoreczenieUslugaKurierskaType $doreczenie = null;
    /**
     * The epo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \app\modules\postal\sender\StructType\OdbiorPrzesylkiOdNadawcyType $odbiorPrzesylkiOdNadawcy
     ...
     * @param \app\modules\postal\sender\StructType\SubUslugaKurierskaType[] $subPrzesylka
     * @param \app\modules\postal\sender\StructType\PotwierdzenieOdbioruKurierskaType $potwierdzenieOdbioru
     * @param \app\modules\postal\sender\StructType\UbezpieczenieType $ubezpieczenie
     * @param \app\modules\postal\sender\StructType\ZwrotDokumentowKurierskaType $zwrotDokumentow
     * @param int $idDokumentyZwrotneAdresy
     * @param \app\modules\postal\sender\StructType\DoreczenieUslugaKurierskaType $doreczenie
     ...
     * @return \app\modules\postal\sender\StructType\OdbiorPrzesylkiOdNadawcyType|null
     */
    public function getOdbiorPrzesylkiOdNadawcy(): ?\app\modules\postal\sender\StructType\OdbiorPrzesylkiOdNadawcyType
    {
     ...
     * @return \app\modules\postal\sender\StructType\UslugaKurierskaType
     */
    public function setOdbiorPrzesylkiOdNadawcy(?\app\modules\postal\sender\StructType\OdbiorPrzesylkiOdNadawcyType $odbiorPrzesylkiOdNadawcy = null): self
    {
     ...
     * @return \app\modules\postal\sender\StructType\SubUslugaKurierskaType[]|null
     */
    ...
    public static function validateSubPrzesylkaForArrayConstraintFromSetSubPrzesylka(?array $values = []): string
    {
        ...
        foreach ($values as $uslugaKurierskaTypeSubPrzesylkaItem) {
            ...
            if (!$uslugaKurierskaTypeSubPrzesylkaItem instanceof \app\modules\postal\sender\StructType\SubUslugaKurierskaType) {
     ...
     * @throws InvalidArgumentException
     * @param \app\modules\postal\sender\StructType\SubUslugaKurierskaType $item
     * @return \app\modules\postal\sender\StructType\UslugaKurierskaType
     */
    public function addToSubPrzesylka(\app\modules\postal\sender\StructType\SubUslugaKurierskaType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \app\modules\postal\sender\StructType\SubUslugaKurierskaType) {
     ...
     * @return \app\modules\postal\sender\StructType\PotwierdzenieOdbioruKurierskaType|null
     */
    public function getPotwierdzenieOdbioru(): ?\app\modules\postal\sender\StructType\PotwierdzenieOdbioruKurierskaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\UslugaKurierskaType
     */
    public function setPotwierdzenieOdbioru(?\app\modules\postal\sender\StructType\PotwierdzenieOdbioruKurierskaType $potwierdzenieOdbioru = null): self
    {
     ...
     * @return \app\modules\postal\sender\StructType\ZwrotDokumentowKurierskaType|null
     */
    public function getZwrotDokumentow(): ?\app\modules\postal\sender\StructType\ZwrotDokumentowKurierskaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\UslugaKurierskaType
     */
    public function setZwrotDokumentow(?\app\modules\postal\sender\StructType\ZwrotDokumentowKurierskaType $zwrotDokumentow = null): self
    {
     ...
     * @return \app\modules\postal\sender\StructType\DoreczenieUslugaKurierskaType|null
     */
    public function getDoreczenie(): ?\app\modules\postal\sender\StructType\DoreczenieUslugaKurierskaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\UslugaKurierskaType
     */
    public function setDoreczenie(?\app\modules\postal\sender\StructType\DoreczenieUslugaKurierskaType $doreczenie = null): self
    {
    ...
    /**
     * Set termin value
     * @uses \app\modules\postal\sender\EnumType\TerminKurierskaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\TerminKurierskaType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $termin
     * @return \app\modules\postal\sender\StructType\UslugaKurierskaType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\TerminKurierskaType::valueIsValid($termin)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\TerminKurierskaType', is_array($termin) ? implode(', ', $termin) : var_export($termin, true), implode(', ', \app\modules\postal\sender\EnumType\TerminKurierskaType::getValidValues())), __LINE__);
        }
        $this->termin = $termin;
     ...
     * @uses \app\modules\postal\sender\EnumType\OpakowanieKurierskaType::valueIsValid()
     * @uses \app\modules\postal\sender\EnumType\OpakowanieKurierskaType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $opakowanie
     * @return \app\modules\postal\sender\StructType\UslugaKurierskaType
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\sender\EnumType\OpakowanieKurierskaType::valueIsValid($opakowanie)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\OpakowanieKurierskaType', is_array($opakowanie) ? implode(', ', $opakowanie) : var_export($opakowanie, true), implode(', ', \app\modules\postal\sender\EnumType\OpakowanieKurierskaType::getValidValues())), __LINE__);
        }
