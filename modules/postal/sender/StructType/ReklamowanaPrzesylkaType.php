...
class ReklamowanaPrzesylkaType extends AbstractStructBase
{
     ...
     */
    protected ?\app\modules\postal\sender\StructType\PrzesylkaType $przesylka = null;
    /**
     * The powodReklamacji
     * @var \app\modules\postal\sender\StructType\PowodReklamacjiType|null
     */
    protected ?\app\modules\postal\sender\StructType\PowodReklamacjiType $powodReklamacji = null;
    /**
     * The nrb
     * Meta information extracted from the WSDL
     * - base: xsd:string
     ...
     * @param \app\modules\postal\sender\StructType\PrzesylkaType $przesylka
     * @param \app\modules\postal\sender\StructType\PowodReklamacjiType $powodReklamacji
     * @param string $nrb
     ...
     */
    public function __construct(string $dataNadania, ?\app\modules\postal\sender\StructType\PrzesylkaType $przesylka = null, ?\app\modules\postal\sender\StructType\PowodReklamacjiType $powodReklamacji = null, ?string $nrb = null, ?string $numerFaktury = null, ?bool $ezgoda = null, ?int $urzadNadania = null, ?string $powodReklamacjiOpis = null, ?int $odszkodowanie = null, ?int $oplata = null, ?int $oczekiwaneOdszkodowanie = null)
    {
        $this
     ...
     */
    public function getPrzesylka(): ?\app\modules\postal\sender\StructType\PrzesylkaType
    {
     ...
     * @return \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType
     */
    public function setPrzesylka(?\app\modules\postal\sender\StructType\PrzesylkaType $przesylka = null): self
    {
     ...
     * @return \app\modules\postal\sender\StructType\PowodReklamacjiType|null
     */
    public function getPowodReklamacji(): ?\app\modules\postal\sender\StructType\PowodReklamacjiType
    {
     ...
     * @return \app\modules\postal\sender\StructType\ReklamowanaPrzesylkaType
     */
    public function setPowodReklamacji(?\app\modules\postal\sender\StructType\PowodReklamacjiType $powodReklamacji = null): self
    {
