...
class DeleteParcelContent extends AbstractStructBase
{
    ...
    public static function validateParcelContentForArrayConstraintFromSetParcelContent(?array $values = []): string
    {
        ...
        foreach ($values as $deleteParcelContentParcelContentItem) {
            ...
            if (!$deleteParcelContentParcelContentItem instanceof \app\modules\postal\modules\poczta_polska\sender\StructType\ParcelContentType) {
     ...
     * @param \app\modules\postal\modules\poczta_polska\sender\StructType\ParcelContentType[] $parcelContent
     * @return \app\modules\postal\sender\StructType\DeleteParcelContent
