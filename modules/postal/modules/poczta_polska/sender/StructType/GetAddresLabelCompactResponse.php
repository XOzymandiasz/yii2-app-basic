...
class GetAddresLabelCompactResponse extends AbstractStructBase
{
     ...
     * @param string $pdfContent
     * @return \app\modules\postal\sender\StructType\GetAddresLabelCompactResponse
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getAddresLabelCompactResponseErrorItem) {
            ...
            if (!$getAddresLabelCompactResponseErrorItem instanceof \app\modules\postal\modules\poczta_polska\sender\StructType\ErrorType) {
