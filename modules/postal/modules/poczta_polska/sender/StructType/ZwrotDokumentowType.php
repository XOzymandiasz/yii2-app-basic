...
class ZwrotDokumentowType extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $rodzajPocztex = null, ?\app\modules\postal\modules\poczta_polska\sender\StructType\RodzajListType $rodzajList = null, ?int $odleglosc = null)
    {
        $this
     ...
     * @param string $rodzajPocztex
     * @return \app\modules\postal\sender\StructType\ZwrotDokumentowType
     *@throws InvalidArgumentException
     * @throws InvalidArgumentException
     * @uses \app\modules\postal\modules\poczta_polska\sender\EnumType\TerminRodzajType::getValidValues()
     * @uses \app\modules\postal\modules\poczta_polska\sender\EnumType\TerminRodzajType::valueIsValid()
     */
    public function setRodzajPocztex(?string $rodzajPocztex = null): self
    {
        // validation for constraint: enumeration
        if (!\app\modules\postal\modules\poczta_polska\sender\EnumType\TerminRodzajType::valueIsValid($rodzajPocztex)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \app\modules\postal\sender\EnumType\TerminRodzajType', is_array($rodzajPocztex) ? implode(', ', $rodzajPocztex) : var_export($rodzajPocztex, true), implode(', ', \app\modules\postal\modules\poczta_polska\sender\EnumType\TerminRodzajType::getValidValues())), __LINE__);
        }
