...
class GetAddresLabelByGuidCompactResponse extends AbstractStructBase
{
     ...
     * @param string $pdfContent
     * @return \app\modules\postal\sender\StructType\GetAddresLabelByGuidCompactResponse
     */
    ...
    public static function validateErrorForArrayConstraintFromSetError(?array $values = []): string
    {
        ...
        foreach ($values as $getAddresLabelByGuidCompactResponseErrorItem) {
            ...
            if (!$getAddresLabelByGuidCompactResponseErrorItem instanceof \app\modules\postal\modules\poczta_polska\sender\StructType\ErrorType) {
